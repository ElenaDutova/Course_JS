...
/* Lesson 9 JavaScript Operators */
    ...
    { /* Логические операторы. Logical operators */
        ...
        /* Обычно используются с булевыми (логическими) значениями;
        при этом возвращаемое ими значение также является булевым. */

        /* Однако операторы && и || фактически возвращают значение одного из операндов,
        поэтому, если эти операторы используются с небулевыми величинами,
        то возвращаемая ими величина также может быть не булевой. */

        { /* Оператор Логическое И (&&) */

            /* (Логическая конъюнкция).
            Для набора логических операндов будет истинным тогда и только тогда, когда истинны все операнды.
            В противном случае оно будет ложным. */

            /* Можно отметить, что оператор может работать с 2 и более операндами.
            Зададим переменные со значениями true: */
            let isChecked = true,
                isClosed = true,
                isOpen = true;
            ...
            /* Однако, если хоть одно из значений переменных поменяется на false, 
            то используя console.log мы получим значение false */
        }

        { /* Оператор Логическое ИЛИ (||) */

            /* (Логическая дизъюнкция)
            Для набора логичесвких операндов истинен тогда и только тогда, когда истинны один или несколько его операндов. */
            ...
            /* Если оба и более операнда ложны, возвращает false. */
            /* Используем console.log и получаем значение false: */
            console.log(dogs || rats);
        }

        { /* Оператор Логическое НЕ (!) */

            /* Переводит истину в ложь и наоборот. */
            let red = true;
            console.log(!red);
        }
